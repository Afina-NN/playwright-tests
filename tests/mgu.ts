...
export const fillFields = [
  {
    ...
    secondname: value.field.secondName,
    name: value.field.name,
    surname: value.field.surname,
    gender: value.field.gender,
    birthdate: value.field.birthdate,
    success: true,
  },
  {
    testName: ', поле пароль пустое',
    email: value.field.email,
    password: '',
    secondname: value.field.secondName,
    name: value.field.name,
  ...
  {
    testName: ', поле дата рождения пустое',
    email: value.field.email,
    password: value.field.password,
    secondname: value.field.secondName,
    name: value.field.name,
